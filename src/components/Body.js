...
const Body=()=>{
    ...
    const fetchData=async()=>{
            ...
            const data=await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.4439956&lng=77.4673881&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING")
